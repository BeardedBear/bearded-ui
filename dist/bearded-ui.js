...
var ae = /*@__PURE__*/ u({
	...
	return n;
}, oe = /*#__PURE__*/ M(ae, [["__scopeId", "data-v-213e01d3"]]), N = /*#__PURE__*/ M(/* @__PURE__ */ u({
	__name: "BdLoader",
...
}), [["__scopeId", "data-v-ee888bba"]]), P = Symbol("bdDropdownClose"), F = Symbol("bdSize"), I = /*#__PURE__*/ M(/* @__PURE__ */ u({
	__name: "BdButton",
	props: {
...
}), [["__scopeId", "data-v-0c3319ae"]]), se = /*#__PURE__*/ M(/* @__PURE__ */ u({
...
}), [["__scopeId", "data-v-a46fc946"]]), z = 8, _e = 120, ve = {
	bottom: "top",
	left: "right",
	right: "left",
	top: "bottom"
...
var ye = { class: "bd-dropdown" }, be = ["aria-controls", "aria-expanded"], xe = ["id"], Se = 767, Ce = /*#__PURE__*/ M(/* @__PURE__ */ u({
	...
	setup(e) {
		...
		}), g(f.stop), v(P, b), v(F, w(t, "size")), (t, u) => (_(), o("div", ye, [s("span", {
			ref_key: "triggerEl",
			ref: r,
			"aria-controls": T(a),
		...
		}, [x(t.$slots, "default", { close: b }, void 0, !0)], 42, xe)]));
	}
}), [["__scopeId", "data-v-a6352c44"]]), we = ["disabled"], Te = {
	key: 0,
...
}), [["__scopeId", "data-v-30e9b440"]]), De = ["for"], Oe = [
	"id",
	"disabled",
	"placeholder",
	"type"
...
}), [["__scopeId", "data-v-77f2e0d1"]]), je = { class: "bd-field" }, Me = ["for"], Ne = { class: "bd-select" }, Pe = ["id", "disabled"], Fe = {
	key: 0,
	disabled: "",
	value: ""
...
}), [["__scopeId", "data-v-216f40c8"]]), U = y([]), Re = 0;
function W(e) {
...
var ze = ["onClick"], Be = /*#__PURE__*/ M(/* @__PURE__ */ u({
...
}), [["__scopeId", "data-v-73bf8264"]]), Ve = ["aria-describedby"], He = ["id"], q = 12, J = /*#__PURE__*/ M(/* @__PURE__ */ u({
	__name: "BdTooltip",
	props: {
		content: { default: "" },
		disabled: { type: Boolean },
	...
	setup(e) {
		...
		function f() {
			...
			if (!e || !i) return;
			let a = d(i), { left: o, placement: s, top: c } = B(a, e, {
				align: "center",
				offset: t.offset,
				side: t.side
			}), l = s === "top" || s === "bottom", u = l ? a.left + a.width / 2 - o : a.top + a.height / 2 - c, f = l ? e.offsetWidth : e.offsetHeight;
			e.style.setProperty("--arrow-offset", `${Math.min(Math.max(u, q), f - q)}px`);
		}
		let p = H(f), h = V(f);
		function v(e) {
		...
		async function b() {
			let e = r.value;
			!e || t.disabled || !t.content && !e.textContent?.trim() || (a.value = !0, e.matches(":popover-open") || e.showPopover(), await m(), f(), p.start());
		}
		function S() {
			clearTimeout(l);
			let e = r.value;
		...
		function w(e) {
			e instanceof MouseEvent && v(e), clearTimeout(l), l = setTimeout(b, t.delay);
		}
		return g(() => {
...
//#endregion
export { oe as BdBadge, I as BdButton, se as BdButtonGroup, le as BdCard, pe as BdCheckbox, ge as BdDialog, Ce as BdDropdown, Ee as BdDropdownItem, Ae as BdInput, N as BdLoader, Le as BdSelect, Be as BdToaster, J as BdTooltip, Ue as bdSchemes, W as dismissToast, G as toast, Ge as useTheme, K as useToast };
