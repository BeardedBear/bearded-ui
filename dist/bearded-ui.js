...
}), [["__scopeId", "data-v-1874d4b8"]]), z = 8, ue = 120, de = {
	bottom: "top",
	left: "right",
	right: "left",
	top: "bottom"
...
var me = ["aria-describedby"], he = ["id"], V = 12, H = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdTooltip",
	props: {
		content: { default: "" },
		delay: { default: 150 },
...
}), [["__scopeId", "data-v-9eb98cad"]]), ge = /*#__PURE__*/ P(/* @__PURE__ */ u({
...
}), [["__scopeId", "data-v-e4863f6e"]]), _e = {
	key: 0,
	class: "bd-card-header bd-font-bold"
}, ve = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdCard",
	props: { padding: { default: "default" } },
	setup(e) {
		let t = e;
		return (e, n) => (y(), o("section", { class: h(["bd-card bd-surface bd-squircle", t.padding === "default" ? "" : `bd-card-${t.padding}`]) }, [e.$slots.header ? (y(), o("header", _e, [C(e.$slots, "header", {}, void 0, !0)])) : a("", !0), C(e.$slots, "default", {}, void 0, !0)], 2));
	}
}), [["__scopeId", "data-v-57c01e05"]]), ye = {
	key: 0,
	class: "bd-checkbox-label"
}, be = { class: "bd-checkbox-switch" }, xe = ["disabled"], Se = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdCheckbox",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
	...
	setup(e) {
		...
		return (i, c) => (y(), o("dialog", {
			...
			e.title || e.subtitle || i.$slots.header || i.$slots.actions || !e.hideClose ? (y(), o("header", Ce, [C(i.$slots, "header", {}, () => [s("div", we, [e.title ? (y(), o("h2", Te, T(e.title), 1)) : a("", !0), e.subtitle ? (y(), o("p", {
				key: 1,
				class: "bd-dialog-subtitle",
				title: e.subtitle
			}, T(e.subtitle), 9, Ee)) : a("", !0)])], !0), i.$slots.actions || !e.hideClose ? (y(), o("div", De, [C(i.$slots, "actions", {}, void 0, !0), e.hideClose ? a("", !0) : (y(), o("button", {
				key: 0,
				"aria-label": "Close",
			...
			s("div", Oe, [C(i.$slots, "default", {}, void 0, !0)]),
			i.$slots.footer ? (y(), o("footer", ke, [C(i.$slots, "footer", {}, void 0, !0)])) : a("", !0)
		], 34));
	}
}), [["__scopeId", "data-v-29ccc224"]]), Ae = /* @__PURE__ */ u({
...
}), je = { class: "bd-dropdown" }, Me = ["aria-controls", "aria-expanded"], Ne = ["id"], Pe = 767, Fe = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdDropdown",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		label: { default: "Menu" },
	...
	setup(e) {
		...
		function u() {
			return t.sheetOnMobile && window.innerWidth <= Pe;
		}
		function d() {
		...
		}), _(f.stop), b(I, p), b(L, E(t, "size")), (t, u) => (y(), o("div", je, [s("span", {
			ref_key: "triggerEl",
			ref: r,
			"aria-controls": D(a),
		...
		}, [C(t.$slots, "default", { close: p }, void 0, !0)], 42, Ne)]));
	}
}), [["__scopeId", "data-v-dcc3adb1"]]), Ie = ["disabled"], Le = {
	key: 0,
	class: "bd-dropdown-item-icon"
}, Re = /*#__PURE__*/ P(/* @__PURE__ */ u({
	...
	setup(e) {
		...
		return (t, n) => (y(), o("button", {
			...
			type: "button",
			onClick: r
		}, [e.icon || t.$slots.icon ? (y(), o("span", Le, [C(t.$slots, "icon", {}, () => [(y(), i(w(e.icon), {
			size: "1.2em",
			weight: "bold"
		}))], !0)])) : a("", !0), C(t.$slots, "default", {}, void 0, !0)], 10, Ie));
	}
}), [["__scopeId", "data-v-4877e0ac"]]), ze = { class: "bd-empty-state" }, Be = {
	key: 0,
	class: "bd-empty-state-icon",
	"aria-hidden": "true"
}, Ve = { class: "bd-empty-state-title bd-font-bold" }, He = {
	key: 1,
	class: "bd-empty-state-message"
}, Ue = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdEmptyState",
	props: {
		actionLabel: {},
		message: {},
	...
	setup(e, { emit: t }) {
		let n = t;
		return (t, r) => (y(), o("div", ze, [
			t.$slots.icon ? (y(), o("span", Be, [C(t.$slots, "icon", {}, void 0, !0)])) : a("", !0),
			s("p", Ve, T(e.title), 1),
			e.message ? (y(), o("p", He, T(e.message), 1)) : a("", !0),
...
}), [["__scopeId", "data-v-6a4d7529"]]), We = ["for"], Ge = { class: "bd-field-control" }, Ke = {
	key: 0,
	...
	setup(e, { expose: t }) {
		...
		return t({
			...
			s("div", Ge, [t.$slots.prefix ? (y(), o("span", Ke, [C(t.$slots, "prefix", {}, void 0, !0)])) : a("", !0), M(s("input", p({
				id: D(i),
				ref_key: "el",
				ref: c,
				...
				type: e.type
			}, t.$attrs), null, 16, qe), [[re, r.value]])]),
			typeof e.error == "string" || e.hint ? (y(), o("small", Je, T(e.error || e.hint), 1)) : a("", !0)
		], 2));
	}
}), [["__scopeId", "data-v-d0ded8d5"]]), Xe = { class: "bd-field" }, Ze = ["for"], Qe = { class: "bd-select" }, $e = ["id", "disabled"], et = {
	key: 0,
	disabled: "",
	value: ""
}, tt = ["value"], nt = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdSelect",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		label: {},
	...
	setup(t) {
		...
		return (i, c) => (y(), o("div", Xe, [t.label ? (y(), o("label", {
			key: 0,
			class: "bd-field-label bd-font-bold",
			for: D(r)
		}, T(t.label), 9, Ze)) : a("", !0), s("div", Qe, [M(s("select", {
			id: D(r),
			"onUpdate:modelValue": c[0] ||= (e) => n.value = e,
			class: "bd-select-control bd-font-bold",
			disabled: t.disabled
		}, [t.placeholder ? (y(), o("option", et, T(t.placeholder), 1)) : a("", !0), (y(!0), o(e, null, S(t.options, (e) => (y(), o("option", {
			key: e.value,
			value: e.value
		}, T(e.label), 9, tt))), 128))], 8, $e), [[ie, n.value]]), l(D(N), {
			"aria-hidden": "true",
...
}), [["__scopeId", "data-v-9795c46d"]]), rt = [
	"aria-disabled",
	"aria-valuemax",
	"aria-valuemin",
	"aria-valuenow",
	"tabindex"
], it = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdSlider",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		max: { default: 100 },
...
function ct() {
	Y || typeof document > "u" || (Y = !0, q.value = st(), ae(() => {
...
var Z = [
...
], lt = { class: "bd-theme-picker" }, ut = { class: "bd-theme-picker-inputs" }, dt = { class: "bd-field" }, ft = { class: "bd-field-label bd-font-bold" }, pt = { class: "bd-theme-picker-control" }, mt = ["value"], ht = { class: "bd-field" }, gt = { class: "bd-field-label bd-font-bold" }, _t = { class: "bd-theme-picker-control" }, vt = ["value"], yt = { class: "bd-theme-picker-grid" }, bt = ["aria-pressed", "onClick"], xt = /*#__PURE__*/ P(/* @__PURE__ */ u({
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", lt, [s("div", ut, [s("label", dt, [s("span", ft, T(t.baseLabel), 1), s("span", pt, [s("input", {
			value: D(i).base,
			type: "color",
			onInput: r[0] ||= (e) => d("base", e)
		}, null, 40, mt), s("code", null, T(D(i).base), 1)])]), s("label", ht, [s("span", gt, T(t.accentLabel), 1), s("span", _t, [s("input", {
			value: D(i).accent,
			type: "color",
			onInput: r[1] ||= (e) => d("accent", e)
		}, null, 40, vt), s("code", null, T(D(i).accent), 1)])])]), (y(!0), o(e, null, S(a.value, (t) => (y(), o("div", {
			key: t.group,
			class: "bd-theme-picker-group"
		}, [s("h3", null, T(t.group), 1), s("div", yt, [(y(!0), o(e, null, S(t.presets, (e) => (y(), o("button", {
			key: e.name,
			"aria-pressed": u(e),
		...
		}, [s("span", { style: g({ background: e.accent }) }, null, 4)], 4), c(" " + T(e.name), 1)], 8, bt))), 128))])]))), 128))]));
	}
}), [["__scopeId", "data-v-f56bcc72"]]), Q = x([]), St = 0;
function $(e) {
	Q.value = Q.value.filter((t) => t.id !== e);
}
function Ct(e, t = {}) {
	let { action: n, duration: r = 4e3, variant: i = "default" } = t, a = St++;
...
var Tt = ["onClick"], Et = { class: "bd-toast-msg" }, Dt = ["onClick"], Ot = ["onClick"], kt = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdToaster",
	props: { position: { default: "bottom-right" } },
	setup(r) {
		let a = r, { dismissToast: c, toasts: u } = wt();
		function d(e) {
		...
		return (r, f) => (y(), i(t, { to: "body" }, [l(n, {
			...
			default: j(() => [(y(!0), o(e, null, S(D(u).filter((e) => !e.action), (e) => (y(), o("button", {
				...
				type: "button",
				onClick: (t) => D(c)(e.id)
			}, T(e.msg), 11, Tt))), 128)), (y(!0), o(e, null, S(D(u).filter((e) => e.action), (e) => (y(), o("div", {
				key: `action-${e.id}`,
				"aria-live": "polite",
...
//#endregion
export { le as BdBadge, R as BdButton, ge as BdButtonGroup, ve as BdCard, Se as BdCheckbox, Ae as BdConfirmDialog, U as BdDialog, Fe as BdDropdown, Re as BdDropdownItem, Ue as BdEmptyState, Ye as BdInput, F as BdLoader, nt as BdSelect, it as BdSlider, xt as BdThemePicker, kt as BdToaster, H as BdTooltip, G as bdDefaultPalette, Z as bdPresets, $ as dismissToast, W as isLightColor, Ct as toast, X as useTheme, wt as useToast };
