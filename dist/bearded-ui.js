...
}), [["__scopeId", "data-v-29416f7d"]]), B = 8, le = 120, ue = {
	bottom: "top",
	left: "right",
	right: "left",
	top: "bottom"
...
var de = ["aria-describedby"], fe = ["id"], W = 12, G = /*#__PURE__*/ F(/* @__PURE__ */ u({
	...
	setup(e) {
		...
		async function j() {
			let e = r.value;
			!e || t.disabled || !t.content && !e.textContent?.trim() || (a.value = !0, d()?.setAttribute("aria-describedby", i), e.matches(":popover-open") || e.showPopover(), await m(), a.value && (p(), b.start()));
		}
		return _(() => {
...
}), [["__scopeId", "data-v-7f16e25c"]]), pe = /*#__PURE__*/ F(/* @__PURE__ */ u({
...
}, Ce = { class: "bd-dialog-subtitle" }, we = {
	key: 0,
	...
	setup(e) {
		...
		return (c, u) => (y(), o("dialog", {
			...
			e.title || e.subtitle || c.$slots.header || c.$slots.actions || !e.hideClose ? (y(), o("header", be, [C(c.$slots, "header", {}, () => [s("div", xe, [e.title ? (y(), o("h2", Se, T(e.title), 1)) : a("", !0), e.subtitle ? (y(), i(G, {
				key: 1,
				bare: "",
				content: e.subtitle
			}, {
				default: N(() => [s("p", Ce, T(e.subtitle), 1)]),
				_: 1
			}, 8, ["content"])) : a("", !0)])], !0), c.$slots.actions || !e.hideClose ? (y(), o("div", we, [C(c.$slots, "actions", {}, void 0, !0), e.hideClose ? a("", !0) : (y(), o("button", {
				key: 0,
				"aria-label": "Close",
			...
			s("div", Te, [C(c.$slots, "default", {}, void 0, !0)]),
			c.$slots.footer ? (y(), o("footer", Ee, [C(c.$slots, "footer", {}, void 0, !0)])) : a("", !0)
		], 38));
	}
}), [["__scopeId", "data-v-d73e348a"]]), De = /* @__PURE__ */ u({
...
var dt = { class: "bd-theme-picker" }, ft = { class: "bd-theme-picker-row" }, pt = { class: "bd-font-bold" }, mt = ["value"], ht = { class: "bd-theme-picker-row" }, gt = { class: "bd-font-bold" }, _t = ["value"], vt = { class: "bd-theme-picker-grid" }, yt = [
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", dt, [
			...
			}, [s("h3", null, T(t.group), 1), s("div", vt, [(y(!0), o(e, null, S(t.presets, (e) => (y(), i(G, {
				key: e.name,
				bare: "",
				content: e.name
			}, {
