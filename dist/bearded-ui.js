...
var ae = /*@__PURE__*/ u({
	...
	setup(e) {
		...
		return k(n, (e) => {
			...
			onClose: c[0] ||= (e) => n.value = !1
		}, [
			e.title || i.$slots.header ? (v(), o("header", me, [S(i.$slots, "header", {}, () => [s("h2", he, w(e.title), 1)], !0)])) : a("", !0),
			s("div", ge, [S(i.$slots, "default", {}, void 0, !0)]),
			i.$slots.footer ? (v(), o("footer", _e, [S(i.$slots, "footer", {}, void 0, !0)])) : a("", !0)
		], 34));
	}
}), [["__scopeId", "data-v-9eddd2a9"]]), R = 8, ye = 120, be = {
	bottom: "top",
	left: "right",
	right: "left",
	top: "bottom"
