import { Fragment as e, Teleport as t, TransitionGroup as n, computed as r, createBlock as i, createCommentVNode as a, createElementBlock as o, createElementVNode as s, createTextVNode as c, createVNode as l, defineComponent as u, inject as d, mergeModels as f, mergeProps as p, nextTick as m, normalizeClass as h, normalizeStyle as g, onBeforeUnmount as _, onMounted as v, openBlock as y, provide as b, ref as x, renderList as S, renderSlot as C, resolveDynamicComponent as w, toDisplayString as T, toRef as E, unref as D, useAttrs as ee, useId as O, useModel as k, useSlots as A, vModelCheckbox as j, vModelDynamic as te, vModelSelect as ne, watch as M, watchEffect as re, withCtx as N, withDirectives as P, withKeys as ie } from "vue";
import { PhCaretDown as ae, PhX as oe } from "@phosphor-icons/vue";
...
var se = /*@__PURE__*/ u({
	...
	return n;
}, ce = /*#__PURE__*/ F(se, [["__scopeId", "data-v-f4bfdac3"]]), I = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdLoader",
...
}), [["__scopeId", "data-v-b8c1bbb7"]]), L = Symbol("bdDropdownClose"), R = Symbol("bdSize"), z = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdButton",
	props: {
		active: { type: Boolean },
	...
	setup(e) {
		let t = e;
		ee(), A();
		let n = d(R, void 0), o = r(() => t.size ?? n?.value ?? "default"), s = r(() => t.as ? t.as : t.to ? "router-link" : t.href ? "a" : "button"), c = r(() => s.value === "router-link" ? { to: t.to } : s.value === "a" ? {
			href: t.href,
...
}), [["__scopeId", "data-v-b3b98cb7"]]), B = 8, le = 120, ue = {
	bottom: "top",
	left: "right",
	right: "left",
	top: "bottom"
...
function V(e, t, n = {}) {
	...
	let u = {
		...
		top: l.top
	}, f = s === "top" || s === "bottom", p = ue[s], m = (f ? u.height : u.width) + o + B, h = d[s] >= m || d[s] >= d[p] ? s : p, g = Math.max(d[h] - o - B, le), _ = Math.min(f ? u.height : u.width, g), v = h === "top" || h === "left" ? (f ? l.top : l.left) - o - _ : (f ? l.bottom : l.right) + o, y = f ? l.left : l.top, b = f ? l.right : l.bottom, x = f ? u.width : u.height, S = f ? window.innerWidth : window.innerHeight, C = r === "end" ? b - x : r === "center" ? y + (b - y - x) / 2 : y, w = Math.min(Math.max(B, C), Math.max(B, S - x - B)), T = f ? v : w, E = f ? w : v;
...
var de = ["aria-describedby"], fe = ["id"], W = 12, G = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdTooltip",
	props: {
		bare: {
			type: Boolean,
	...
	setup(e) {
		...
		function p() {
			...
			if (!e || !i) return;
			let a = g(i), { left: o, placement: s, top: c } = V(a, e, {
				align: "center",
				offset: t.offset,
				side: t.side
			}), l = s === "top" || s === "bottom", u = l ? a.left + a.width / 2 - o : a.top + a.height / 2 - c, d = l ? e.offsetWidth : e.offsetHeight;
			e.style.setProperty("--arrow-offset", `${Math.min(Math.max(u, W), d - W)}px`);
		}
		function g(e) {
			let n = v(e);
		...
		function w() {
			clearTimeout(l);
			let e = r.value;
			d()?.removeAttribute("aria-describedby"), a.value = !1, e?.matches(":popover-open") && e.hidePopover(), b.stop();
		}
		function E(e) {
			f(e.relatedTarget) || w();
		}
		function ee(e) {
			f(e.relatedTarget) || A(e);
		}
		function k(e) {
			u.x = e.clientX, u.y = e.clientY, t.follow && a.value && S();
		}
		function A(e) {
			e instanceof MouseEvent && k(e), clearTimeout(l), l = setTimeout(j, t.delay);
		}
		async function j() {
			let e = r.value;
			!e || t.disabled || !t.content && !e.textContent?.trim() || (a.value = !0, d()?.setAttribute("aria-describedby", i), e.matches(":popover-open") || e.showPopover(), await m(), p(), b.start());
		}
		return _(() => {
			clearTimeout(l), b.stop();
		}), (t, l) => (y(), o("span", {
			ref_key: "triggerEl",
			ref: n,
			...
			popover: "manual",
			role: "tooltip"
		}, [C(t.$slots, "content", {}, () => [c(T(e.content), 1)], !0)], 8, fe)], 42, de));
	}
}), [["__scopeId", "data-v-1eb533d8"]]), pe = /*#__PURE__*/ F(/* @__PURE__ */ u({
	...
	setup(t) {
		...
		return b(R, E(n, "size")), (n, a) => (y(), o("div", {
			class: h(["bd-button-group", { "bd-button-group-full": t.full }]),
			role: "group"
		}, [C(n.$slots, "default", {}, () => [(y(!0), o(e, null, S(t.options, (e) => (y(), i(G, {
			key: e.value,
			content: e.tooltip
		}, {
			default: N(() => [l(z, {
...
}), [["__scopeId", "data-v-e4863f6e"]]), me = {
	key: 0,
	class: "bd-card-header bd-font-bold"
}, he = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdCard",
	props: { padding: { default: "default" } },
	setup(e) {
		let t = e;
		return (e, n) => (y(), o("section", { class: h(["bd-card bd-surface bd-squircle", t.padding === "default" ? "" : `bd-card-${t.padding}`]) }, [e.$slots.header ? (y(), o("header", me, [C(e.$slots, "header", {}, void 0, !0)])) : a("", !0), C(e.$slots, "default", {}, void 0, !0)], 2));
	}
}), [["__scopeId", "data-v-57c01e05"]]), ge = {
	key: 0,
	class: "bd-checkbox-label"
}, _e = { class: "bd-checkbox-switch" }, ve = ["disabled"], ye = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdCheckbox",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
	...
	setup(e) {
		...
		}]) }, [e.label || n.$slots.default ? (y(), o("span", ge, [C(n.$slots, "default", {}, () => [c(T(e.label), 1)], !0)])) : a("", !0), s("span", _e, [
			P(s("input", {
...
}), [["__scopeId", "data-v-c8dd0e95"]]), be = {
	key: 0,
	class: "bd-dialog-header"
}, xe = { class: "bd-dialog-heading" }, Se = {
	key: 0,
	class: "bd-dialog-title"
}, Ce = ["title"], we = {
	key: 0,
	class: "bd-dialog-actions"
}, Te = { class: "bd-dialog-body" }, Ee = {
	key: 1,
	class: "bd-dialog-footer"
}, K = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdDialog",
	props: /*@__PURE__*/ f({
	...
	setup(e) {
		...
		return (i, c) => (y(), o("dialog", {
			...
			e.title || e.subtitle || i.$slots.header || i.$slots.actions || !e.hideClose ? (y(), o("header", be, [C(i.$slots, "header", {}, () => [s("div", xe, [e.title ? (y(), o("h2", Se, T(e.title), 1)) : a("", !0), e.subtitle ? (y(), o("p", {
				key: 1,
				class: "bd-dialog-subtitle",
				title: e.subtitle
			}, T(e.subtitle), 9, Ce)) : a("", !0)])], !0), i.$slots.actions || !e.hideClose ? (y(), o("div", we, [C(i.$slots, "actions", {}, void 0, !0), e.hideClose ? a("", !0) : (y(), o("button", {
				key: 0,
				"aria-label": "Close",
			...
			s("div", Te, [C(i.$slots, "default", {}, void 0, !0)]),
			i.$slots.footer ? (y(), o("footer", Ee, [C(i.$slots, "footer", {}, void 0, !0)])) : a("", !0)
		], 38));
	}
}), [["__scopeId", "data-v-ae31909e"]]), De = /* @__PURE__ */ u({
	...
	setup(e, { emit: t }) {
		...
		return (t, n) => (y(), i(K, {
			...
			footer: N(() => [l(z, {
				...
				default: N(() => [c(T(e.cancelLabel), 1)]),
				_: 1
			}), l(z, {
				variant: e.danger ? "danger" : "primary",
				onClick: o
			}, {
				default: N(() => [c(T(e.confirmLabel), 1)]),
				_: 1
			}, 8, ["variant"])]),
			default: N(() => [C(t.$slots, "default", {}, () => [c(T(e.message), 1)])]),
			_: 3
		}, 8, ["model-value", "title"]));
	}
}), Oe = { class: "bd-dropdown" }, ke = ["aria-controls", "aria-expanded"], Ae = ["id"], je = 767, Me = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdDropdown",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		label: { default: "Menu" },
	...
	setup(e) {
		...
		function u() {
			return t.sheetOnMobile && window.innerWidth <= je;
		}
		function d() {
		...
		return M(n, async (e) => {
		...
		}), _(f.stop), b(L, p), b(R, E(t, "size")), (t, u) => (y(), o("div", Oe, [s("span", {
			ref_key: "triggerEl",
			ref: r,
			"aria-controls": D(a),
			...
			open: n.value,
			toggle: v
		}, () => [l(z, { disabled: e.disabled }, {
			default: N(() => [c(T(e.label) + " ", 1), l(D(ae), {
				class: "bd-dropdown-caret",
				size: "1.1em",
				weight: "bold"
			})]),
			_: 1
		}, 8, ["disabled"])], !0)], 8, ke), s("div", {
			id: D(a),
			ref_key: "panelEl",
			ref: i,
		...
		}, [C(t.$slots, "default", { close: p }, void 0, !0)], 42, Ae)]));
	}
}), [["__scopeId", "data-v-7f75263c"]]), Ne = ["disabled"], Pe = {
	key: 0,
	class: "bd-dropdown-item-icon"
}, Fe = /*#__PURE__*/ F(/* @__PURE__ */ u({
	...
	setup(e) {
		...
		return (t, n) => (y(), o("button", {
			...
			type: "button",
			onClick: r
		}, [e.icon || t.$slots.icon ? (y(), o("span", Pe, [C(t.$slots, "icon", {}, () => [(y(), i(w(e.icon), {
			size: "1.2em",
			weight: "bold"
		}))], !0)])) : a("", !0), C(t.$slots, "default", {}, void 0, !0)], 10, Ne));
	}
}), [["__scopeId", "data-v-4877e0ac"]]), Ie = { class: "bd-empty-state" }, Le = {
	key: 0,
	class: "bd-empty-state-icon",
	"aria-hidden": "true"
}, Re = { class: "bd-empty-state-title bd-font-bold" }, ze = {
	key: 1,
	...
	setup(e, { emit: t }) {
		let n = t;
		return (t, r) => (y(), o("div", Ie, [
			t.$slots.icon ? (y(), o("span", Le, [C(t.$slots, "icon", {}, void 0, !0)])) : a("", !0),
			s("p", Re, T(e.title), 1),
			e.message ? (y(), o("p", ze, T(e.message), 1)) : a("", !0),
...
}), [["__scopeId", "data-v-6a4d7529"]]), Ve = ["for"], He = { class: "bd-field-control" }, Ue = {
	key: 0,
	...
	setup(e, { expose: t }) {
		...
		return t({
			...
			s("div", He, [t.$slots.prefix ? (y(), o("span", Ue, [C(t.$slots, "prefix", {}, void 0, !0)])) : a("", !0), P(s("input", p({
				id: D(i),
				ref_key: "el",
				ref: c,
				...
				type: e.type
			}, t.$attrs), null, 16, We), [[te, r.value]])]),
			typeof e.error == "string" || e.hint ? (y(), o("small", Ge, T(e.error || e.hint), 1)) : a("", !0)
		], 2));
	}
}), [["__scopeId", "data-v-d0ded8d5"]]), qe = { class: "bd-field" }, Je = ["for"], Ye = { class: "bd-select" }, Xe = ["id", "disabled"], Ze = {
	key: 0,
	disabled: "",
	value: ""
}, Qe = ["value"], $e = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdSelect",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		label: {},
	...
	setup(t) {
		...
		return (i, c) => (y(), o("div", qe, [t.label ? (y(), o("label", {
			key: 0,
			class: "bd-field-label bd-font-bold",
			for: D(r)
		}, T(t.label), 9, Je)) : a("", !0), s("div", Ye, [P(s("select", {
			id: D(r),
			"onUpdate:modelValue": c[0] ||= (e) => n.value = e,
			class: "bd-select-control bd-font-bold",
			disabled: t.disabled
		}, [t.placeholder ? (y(), o("option", Ze, T(t.placeholder), 1)) : a("", !0), (y(!0), o(e, null, S(t.options, (e) => (y(), o("option", {
			key: e.value,
			value: e.value
		}, T(e.label), 9, Qe))), 128))], 8, Xe), [[ne, n.value]]), l(D(ae), {
			"aria-hidden": "true",
...
}), [["__scopeId", "data-v-9795c46d"]]), et = [
	"aria-disabled",
	"aria-valuemax",
	"aria-valuemin",
	"aria-valuenow",
	"tabindex"
], tt = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdSlider",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		max: { default: 100 },
...
var X = "bearded-ui-theme", it = (e, t) => e.accent.toLowerCase() === t.accent.toLowerCase() && e.base.toLowerCase() === t.base.toLowerCase();
function at(e) {
	return e.name ? J.find((t) => t.name === e.name) : J.find((t) => it(t, e) || t.legacy?.some((t) => it(t, e)));
}
function ot() {
	try {
		let e = JSON.parse(localStorage.getItem(X) ?? "null");
		if (!e?.accent || !e?.base) return q;
		let t = at(e);
		return t ? {
			accent: t.accent,
			base: t.base,
...
var Z = x(q), st = r(() => Y(Z.value.base) ? "light" : "dark"), ct = !1;
function lt() {
	return ut(), {
		palette: Z,
		theme: st
...
function ut() {
	ct || typeof document > "u" || (ct = !0, Z.value = ot(), re(() => {
		let e = document.documentElement;
		e.dataset.theme = st.value, e.style.setProperty("--bd-palette-base", Z.value.base), e.style.setProperty("--bd-palette-accent", Z.value.accent), e.style.setProperty("--bd-on-primary", Y(Z.value.accent) ? "#111" : "#fff"), localStorage.setItem(X, JSON.stringify(Z.value));
	}));
}
//#endregion
...
var dt = { class: "bd-theme-picker" }, ft = { class: "bd-theme-picker-row" }, pt = { class: "bd-font-bold" }, mt = ["value"], ht = { class: "bd-theme-picker-row" }, gt = { class: "bd-font-bold" }, _t = ["value"], vt = { class: "bd-theme-picker-grid" }, yt = [
	...
	setup(t) {
		let n = t, { palette: i } = lt(), a = r(() => [...new Set(n.presets.map((e) => e.group))].map((e) => ({
			group: e,
		...
		return (n, r) => (y(), o("div", dt, [
			s("label", ft, [s("span", pt, T(t.baseLabel), 1), s("input", {
				value: D(i).base,
				type: "color",
				onInput: r[0] ||= (e) => u("base", e)
			}, null, 40, mt)]),
			s("label", ht, [s("span", gt, T(t.accentLabel), 1), s("input", {
				value: D(i).accent,
				type: "color",
				onInput: r[1] ||= (e) => u("accent", e)
			}, null, 40, _t)]),
			r[2] ||= s("hr", { class: "bd-theme-picker-divider" }, null, -1),
			(y(!0), o(e, null, S(a.value, (t) => (y(), o("div", {
				key: t.group,
				class: "bd-theme-picker-group"
			}, [s("h3", null, T(t.group), 1), s("div", vt, [(y(!0), o(e, null, S(t.presets, (e) => (y(), o("button", {
				key: e.name,
				"aria-label": e.name,
				"aria-pressed": l(e),
...
}), [["__scopeId", "data-v-d270ea26"]]), Q = x([]), xt = 0;
function $(e) {
...
var wt = ["onClick"], Tt = { class: "bd-toast-msg" }, Et = ["onClick"], Dt = ["onClick"], Ot = /*#__PURE__*/ F(/* @__PURE__ */ u({
	__name: "BdToaster",
	...
	setup(r) {
		...
		return (r, p) => (y(), i(t, { to: "body" }, [l(n, {
			...
			default: N(() => [(y(!0), o(e, null, S(D(u).filter((e) => !e.action), (e) => (y(), o("button", {
				key: e.id,
				"aria-live": "polite",
...
//#endregion
export { ce as BdBadge, z as BdButton, pe as BdButtonGroup, he as BdCard, ye as BdCheckbox, De as BdConfirmDialog, K as BdDialog, Me as BdDropdown, Fe as BdDropdownItem, Be as BdEmptyState, Ke as BdInput, I as BdLoader, $e as BdSelect, tt as BdSlider, bt as BdThemePicker, Ot as BdToaster, G as BdTooltip, q as bdDefaultPalette, J as bdPresets, $ as dismissToast, Y as isLightColor, St as toast, lt as useTheme, Ct as useToast };
