...
import { PhCaretDown as M, PhX as ae } from "@phosphor-icons/vue";
...
var oe = /*@__PURE__*/ u({
	...
	return n;
}, se = /*#__PURE__*/ N(oe, [["__scopeId", "data-v-f4bfdac3"]]), P = /*#__PURE__*/ N(/* @__PURE__ */ u({
	__name: "BdLoader",
...
}), [["__scopeId", "data-v-51a7af58"]]), ce = /*#__PURE__*/ N(/* @__PURE__ */ u({
...
}), [["__scopeId", "data-v-6fe4edbf"]]), le = {
	key: 0,
	class: "bd-card-header bd-font-bold"
}, ue = /*#__PURE__*/ N(/* @__PURE__ */ u({
	__name: "BdCard",
	props: { padding: { default: "default" } },
	setup(e) {
		let t = e;
		return (e, n) => (v(), o("section", { class: h(["bd-card bd-surface bd-squircle", t.padding === "default" ? "" : `bd-card-${t.padding}`]) }, [e.$slots.header ? (v(), o("header", le, [S(e.$slots, "header", {}, void 0, !0)])) : a("", !0), S(e.$slots, "default", {}, void 0, !0)], 2));
	}
}), [["__scopeId", "data-v-57c01e05"]]), de = {
	key: 0,
	class: "bd-checkbox-label"
}, fe = { class: "bd-checkbox-switch" }, pe = ["disabled"], me = /*#__PURE__*/ N(/* @__PURE__ */ u({
	__name: "BdCheckbox",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
	...
	setup(e) {
		...
		return (i, c) => (v(), o("dialog", {
			...
			e.title || e.subtitle || i.$slots.header || i.$slots.actions || !e.hideClose ? (v(), o("header", he, [S(i.$slots, "header", {}, () => [s("div", ge, [e.title ? (v(), o("h2", _e, w(e.title), 1)) : a("", !0), e.subtitle ? (v(), o("p", {
				key: 1,
				class: "bd-dialog-subtitle",
				title: e.subtitle
			}, w(e.subtitle), 9, ve)) : a("", !0)])], !0), i.$slots.actions || !e.hideClose ? (v(), o("div", ye, [S(i.$slots, "actions", {}, void 0, !0), e.hideClose ? a("", !0) : (v(), o("button", {
				key: 0,
				"aria-label": "Close",
			...
			s("div", be, [S(i.$slots, "default", {}, void 0, !0)]),
			i.$slots.footer ? (v(), o("footer", xe, [S(i.$slots, "footer", {}, void 0, !0)])) : a("", !0)
		], 34));
	}
}), [["__scopeId", "data-v-4b56a935"]]), Se = /* @__PURE__ */ u({
	...
	setup(e, { emit: t }) {
		...
		return (t, n) => (v(), i(R, {
			...
			footer: A(() => [l(L, {
				...
				default: A(() => [c(w(e.cancelLabel), 1)]),
				_: 1
			}), l(L, {
				variant: e.danger ? "danger" : "primary",
				onClick: o
			}, {
				default: A(() => [c(w(e.confirmLabel), 1)]),
				_: 1
			}, 8, ["variant"])]),
			default: A(() => [S(t.$slots, "default", {}, () => [c(w(e.message), 1)])]),
			_: 3
		}, 8, ["model-value", "title"]));
	}
}), z = 8, Ce = 120, we = {
...
function B(e, t, n = {}) {
	...
	let l = {
		...
		top: c.top
	}, d = s === "top" || s === "bottom", f = we[s], p = (d ? l.height : l.width) + o + z, m = u[s] >= p || u[s] >= u[f] ? s : f, h = Math.max(u[m] - o - z, Ce), g = Math.min(d ? l.height : l.width, h), _ = m === "top" || m === "left" ? (d ? c.top : c.left) - o - g : (d ? c.bottom : c.right) + o, v = d ? c.left : c.top, y = d ? c.right : c.bottom, b = d ? l.width : l.height, x = d ? window.innerWidth : window.innerHeight, S = r === "end" ? y - b : r === "center" ? v + (y - v - b) / 2 : v, C = Math.min(Math.max(z, S), Math.max(z, x - b - z)), w = d ? _ : C, T = d ? C : _;
...
var Te = { class: "bd-dropdown" }, Ee = ["aria-controls", "aria-expanded"], De = ["id"], Oe = 767, ke = /*#__PURE__*/ N(/* @__PURE__ */ u({
	__name: "BdDropdown",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		label: { default: "Menu" },
	...
	setup(e) {
		...
		function u() {
			return t.sheetOnMobile && window.innerWidth <= Oe;
		}
		function d() {
		...
		}), _(f.stop), y(F, p), y(I, T(t, "size")), (t, u) => (v(), o("div", Te, [s("span", {
			ref_key: "triggerEl",
			ref: r,
			"aria-controls": E(a),
		...
		}, [S(t.$slots, "default", { close: p }, void 0, !0)], 42, De)]));
	}
}), [["__scopeId", "data-v-dcc3adb1"]]), Ae = ["disabled"], je = {
	key: 0,
	...
	setup(e) {
		...
		return (t, n) => (v(), o("button", {
			...
			type: "button",
			onClick: r
		}, [e.icon || t.$slots.icon ? (v(), o("span", je, [S(t.$slots, "icon", {}, () => [(v(), i(C(e.icon), {
			size: "1.2em",
			weight: "bold"
		}))], !0)])) : a("", !0), S(t.$slots, "default", {}, void 0, !0)], 10, Ae));
	}
}), [["__scopeId", "data-v-4877e0ac"]]), Ne = ["for"], Pe = [
	"id",
	"disabled",
	"placeholder",
	"type"
	...
	setup(e) {
		...
		return (r, i) => (v(), o("div", { class: h(["bd-field", { "has-error": e.error }]) }, [
			...
			j(s("input", {
				...
				type: e.type
			}, null, 8, Pe), [[te, t.value]]),
			e.error || e.hint ? (v(), o("small", Fe, w(e.error || e.hint), 1)) : a("", !0)
		], 2));
	}
}), [["__scopeId", "data-v-a22b02f8"]]), Le = { class: "bd-field" }, Re = ["for"], ze = { class: "bd-select" }, Be = ["id", "disabled"], Ve = {
	key: 0,
	disabled: "",
	value: ""
}, He = ["value"], Ue = /*#__PURE__*/ N(/* @__PURE__ */ u({
	__name: "BdSelect",
	props: /*@__PURE__*/ f({
		disabled: { type: Boolean },
		label: {},
	...
	setup(t) {
		...
		return (i, c) => (v(), o("div", Le, [t.label ? (v(), o("label", {
			key: 0,
			class: "bd-field-label bd-font-bold",
			for: E(r)
		}, w(t.label), 9, Re)) : a("", !0), s("div", ze, [j(s("select", {
			id: E(r),
			"onUpdate:modelValue": c[0] ||= (e) => n.value = e,
			class: "bd-select-control bd-font-bold",
			disabled: t.disabled
		}, [t.placeholder ? (v(), o("option", Ve, w(t.placeholder), 1)) : a("", !0), (v(!0), o(e, null, x(t.options, (e) => (v(), o("option", {
			key: e.value,
			value: e.value
		}, w(e.label), 9, He))), 128))], 8, Be), [[ne, n.value]]), l(E(M), {
			"aria-hidden": "true",
...
function Ke() {
	try {
		...
		return e?.accent && e?.base ? e : W;
	} catch {
		return W;
	}
}
var K = b(W), q = r(() => U(K.value.base) ? "light" : "dark"), J = !1;
function Y() {
	return qe(), {
		palette: K,
		theme: q
...
function qe() {
	J || typeof document > "u" || (J = !0, K.value = Ke(), re(() => {
		let e = document.documentElement;
		e.dataset.theme = q.value, e.style.setProperty("--bd-palette-base", K.value.base), e.style.setProperty("--bd-palette-accent", K.value.accent), e.style.setProperty("--bd-on-primary", U(K.value.accent) ? "#111" : "#fff"), localStorage.setItem(G, JSON.stringify(K.value));
	}));
}
//#endregion
...
var X = [
...
], Je = { class: "bd-theme-picker" }, Ye = { class: "bd-theme-picker-inputs" }, Xe = { class: "bd-field" }, Ze = { class: "bd-field-label bd-font-bold" }, Qe = { class: "bd-theme-picker-control" }, $e = ["value"], et = { class: "bd-field" }, tt = { class: "bd-field-label bd-font-bold" }, nt = { class: "bd-theme-picker-control" }, rt = ["value"], it = { class: "bd-theme-picker-grid" }, at = ["aria-pressed", "onClick"], ot = /*#__PURE__*/ N(/* @__PURE__ */ u({
	...
	setup(t) {
		let n = t, { palette: i } = Y(), a = r(() => [...new Set(n.presets.map((e) => e.group))].map((e) => ({
			group: e,
		...
		return (n, r) => (v(), o("div", Je, [s("div", Ye, [s("label", Xe, [s("span", Ze, w(t.baseLabel), 1), s("span", Qe, [s("input", {
			value: E(i).base,
			type: "color",
			onInput: r[0] ||= (e) => d("base", e)
		}, null, 40, $e), s("code", null, w(E(i).base), 1)])]), s("label", et, [s("span", tt, w(t.accentLabel), 1), s("span", nt, [s("input", {
			value: E(i).accent,
			type: "color",
			onInput: r[1] ||= (e) => d("accent", e)
		}, null, 40, rt), s("code", null, w(E(i).accent), 1)])])]), (v(!0), o(e, null, x(a.value, (t) => (v(), o("div", {
			key: t.group,
			class: "bd-theme-picker-group"
		}, [s("h3", null, w(t.group), 1), s("div", it, [(v(!0), o(e, null, x(t.presets, (e) => (v(), o("button", {
			key: e.name,
			"aria-pressed": u(e),
		...
		}, [s("span", { style: g({ background: e.accent }) }, null, 4)], 4), c(" " + w(e.name), 1)], 8, at))), 128))])]))), 128))]));
	}
}), [["__scopeId", "data-v-f56bcc72"]]), Z = b([]), st = 0;
function Q(e) {
	Z.value = Z.value.filter((t) => t.id !== e);
}
function $(e, t = {}) {
	let { duration: n = 4e3, variant: r = "default" } = t, i = st++;
	return Z.value = [...Z.value, {
		id: i,
		msg: e,
		variant: r
	}], n > 0 && setTimeout(() => Q(i), n), i;
}
function ct() {
	return {
		dismissToast: Q,
...
var lt = ["onClick"], ut = /*#__PURE__*/ N(/* @__PURE__ */ u({
	__name: "BdToaster",
	props: { position: { default: "bottom-right" } },
	setup(r) {
		let a = r, { dismissToast: s, toasts: c } = ct();
...
}), [["__scopeId", "data-v-eaee107b"]]), dt = ["aria-describedby"], ft = ["id"], pt = 12, mt = /*#__PURE__*/ N(/* @__PURE__ */ u({
	__name: "BdTooltip",
	props: {
		content: { default: "" },
		delay: { default: 150 },
	...
	setup(e) {
		...
		function d() {
			...
			e.style.setProperty("--arrow-offset", `${Math.min(Math.max(u, pt), d - pt)}px`);
		}
		function f(e) {
		...
		return _(() => {
			...
			popover: "manual",
			role: "tooltip"
		}, [S(t.$slots, "content", {}, () => [c(w(e.content), 1)], !0)], 8, ft)], 40, dt));
	}
}), [["__scopeId", "data-v-9eb98cad"]]);
//#endregion
export { se as BdBadge, L as BdButton, ce as BdButtonGroup, ue as BdCard, me as BdCheckbox, Se as BdConfirmDialog, R as BdDialog, ke as BdDropdown, Me as BdDropdownItem, Ie as BdInput, P as BdLoader, Ue as BdSelect, ot as BdThemePicker, ut as BdToaster, mt as BdTooltip, W as bdDefaultPalette, X as bdPresets, Q as dismissToast, U as isLightColor, $ as toast, Y as useTheme, ct as useToast };
