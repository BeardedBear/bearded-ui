...
var dt = { class: "bd-theme-picker" }, ft = { class: "bd-theme-picker-inputs" }, pt = { class: "bd-field" }, mt = { class: "bd-field-label bd-font-bold" }, ht = { class: "bd-theme-picker-control" }, gt = ["value"], _t = { class: "bd-field" }, vt = { class: "bd-field-label bd-font-bold" }, yt = { class: "bd-theme-picker-control" }, bt = ["value"], xt = { class: "bd-theme-picker-grid" }, St = ["aria-pressed", "onClick"], Ct = { class: "bd-theme-picker-name" }, wt = /*#__PURE__*/ P(/* @__PURE__ */ u({
	...
	setup(t) {
		...
		}, [s("span", { style: g({ background: e.accent }) }, null, 4)], 4), s("span", Ct, T(e.name), 1)], 8, St))), 128))])]))), 128))]));
	}
}), [["__scopeId", "data-v-186de236"]]), Q = x([]), Tt = 0;
function $(e) {
	Q.value = Q.value.filter((t) => t.id !== e);
}
function Et(e, t = {}) {
	let { action: n, duration: r = 4e3, variant: i = "default" } = t, a = Tt++;
...
var Ot = ["onClick"], kt = { class: "bd-toast-msg" }, At = ["onClick"], jt = ["onClick"], Mt = /*#__PURE__*/ P(/* @__PURE__ */ u({
	__name: "BdToaster",
	props: { position: { default: "bottom-right" } },
	setup(r) {
		let a = r, { dismissToast: c, toasts: u } = Dt();
		function d(e) {
		...
		return (r, f) => (y(), i(t, { to: "body" }, [l(n, {
			...
			default: j(() => [(y(!0), o(e, null, S(D(u).filter((e) => !e.action), (e) => (y(), o("button", {
				...
				type: "button",
				onClick: (t) => D(c)(e.id)
			}, T(e.msg), 11, Ot))), 128)), (y(!0), o(e, null, S(D(u).filter((e) => e.action), (e) => (y(), o("div", {
				key: `action-${e.id}`,
				"aria-live": "polite",
...
//#endregion
export { le as BdBadge, R as BdButton, _e as BdButtonGroup, ye as BdCard, Ce as BdCheckbox, je as BdConfirmDialog, H as BdDialog, Ie as BdDropdown, ze as BdDropdownItem, We as BdEmptyState, Xe as BdInput, F as BdLoader, rt as BdSelect, at as BdSlider, wt as BdThemePicker, Mt as BdToaster, V as BdTooltip, U as bdDefaultPalette, W as bdPresets, $ as dismissToast, G as isLightColor, Et as toast, Z as useTheme, Dt as useToast };
