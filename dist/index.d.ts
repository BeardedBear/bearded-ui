...
declare const __VLS_component_9: DefineComponent<BdTooltipProps, {}, {}, {}, {}, ComponentOptionsMixin, ComponentOptionsMixin, {}, string, PublicProps, Readonly<BdTooltipProps> & Readonly<{}>, {
offset: number;
side: BdSide;
content: string;
delay: number;
...
export declare const BdInput: DefineComponent<__VLS_PublicProps_5, {}, {}, {}, {}, ComponentOptionsMixin, ComponentOptionsMixin, {
...
export declare type BdScheme = "apple" | "blue" | "crimson" | "default" | "orange";

/** Every accent scheme, in display order — for building a picker. */
export declare const bdSchemes: BdScheme[];
...
export declare const BdTooltip: __VLS_WithTemplateSlots_9<typeof __VLS_component_9, __VLS_TemplateResult_9["slots"]>;
...
declare const scheme: Ref<BdScheme, BdScheme>;

declare const theme: Ref<BdTheme, BdTheme>;
